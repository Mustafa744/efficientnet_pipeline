...
train_tfrecord_file = vh.inputs("train_tfrecord").path()
validate_tfrecord_file = vh.inputs("validate_tfrecord").path()
test_tfrecord_file = vh.inputs("test_tfrecord").path()
